...
class LEGOLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        if hasattr(config, "mm_vision_tower"):
            ...
            imagebind_path = os.getenv(
                "GROUNDINGGPT_IMAGEBIND_PATH",
                "/mnt/sdc/xingjianwang/yibowang/GroundingGPT/ckpt/imagebind/imagebind_huge.pth",
            )
            self.audio_encoder.load_state_dict(torch.load(imagebind_path))
    ...
    def init_video_Qformer(cls, num_query_token, vision_width,num_hidden_layers =2):
        bert_path = os.getenv(
            "GROUNDINGGPT_BERT_PATH",
            "/mnt/sdc/xingjianwang/yibowang/GroundingGPT/ckpt/bert-base-uncased",
        )
