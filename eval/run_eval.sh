...
export PYTHONPATH="${LLAVA_ST_SOURCE_DIR}:${PYTHONPATH:-}"
export LLAVA_ST_MAX_FRAMES="${LLAVA_ST_MAX_FRAMES:-100}"
export LLAVA_ST_USE_CACHE="${LLAVA_ST_USE_CACHE:-1}"
...
echo "LLaVA-ST Source:         $LLAVA_ST_SOURCE_DIR"
echo "LLaVA-ST Max Frames:     $LLAVA_ST_MAX_FRAMES"
echo "=========================================="
echo ""
