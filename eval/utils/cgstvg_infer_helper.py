...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run official CG-STVG inference for DORO-STVG manifest rows.")
    parser.add_argument("--manifest", required=True)
    parser.add_argument("--output", required=True)
    parser.add_argument("--cgstvg-dir", required=True)
