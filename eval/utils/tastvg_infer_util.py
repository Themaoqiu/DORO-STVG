...
def main(
    ...
    num_workers: str = "0",
    config_file: str = "experiments/vidstg.yaml",
    test_script: str = "scripts/test_net.py",
    result_file: str = "test_results.json",
    prepare_cache: bool = False,
    official_extra_opts: str = "",
) -> None:
    run_tastvg_util(
        manifest=manifest,
        output=output,
        tastvg_dir=tastvg_dir,
        ...
        official_extra_opts=shlex.split(official_extra_opts),
    )
